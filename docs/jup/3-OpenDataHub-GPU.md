...
![UI Create Project](/images/3-createprojectname.png)
...
![UI Install Open Data Hub](/images/3-installedoperator.png)    
...
![UI Install Open Data Hub](/images/3-createinstance.png)  
...
![UI Project workload](/images/3-projectworkload.png) 

13. Click Routes under Networking and url to launch Jupyterhub is created
![UI Project workload routes](/images/3-projectworkload-routes.png)

14. Open JupyterHub on web browser
![UI JupyterHub](/images/3-jupyterhub.png)

15. Configure GPU and start server
![UI Start Server](/images/3-jupyterhub-gpu-size-startserver.png)

16. Check for GPU in notebook
![UI GPUCheck](/images/3-GPUcheck_notebook.png)